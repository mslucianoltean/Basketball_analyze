...
def initialize_firebase():
    ...
    try:
        if 'firebase_admin' not in globals():
            # Avertizarea ramane in caz ca lipseste din requirements.txt
            return False
...
def run_hybrid_analyzer(data: dict) -> (str, dict):
    ...
    try:
        ...
        for line in tp_lines:
            # CORECTIE CRUCIALĂ: Extragem datele direct din dictionarul 'data' al formularului
            # Cheile sunt de forma 'tp_line_close', 'tp_open_over_close', etc.
            tp_data[line] = {
        ...
        # Historical Open Line (ne asiguram ca 'close' exista in tp_data)
        # Folosim .get() pentru a prelua datele close in caz ca au ramas 0.0
        ...
        # Arunca o eroare mai detaliata pentru debugging
    ...
    # --- 5. Final Output Generation (CORECTIE PENTRU SIGURANTA) ---
    final_line = initial_line_tp
    
    # Ne asiguram ca dictionarul 'close' exista inainte de a accesa cheile din el
...
def load_analysis_ids():
    ...
    try:
        # Citirea simpla fara ordonare pentru a evita erorile de index/timestamp
        ...
        # Limitarea la 100 de elemente pentru performanta
        return ids[:100]
    except Exception as e:
